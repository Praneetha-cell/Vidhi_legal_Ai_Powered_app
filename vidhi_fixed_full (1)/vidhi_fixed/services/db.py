...
# Always resolve to the vidhi_fixed project root, regardless of the
# current working directory the app is launched from. This prevents
# accidental creation of duplicate database files in other folders.
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DB_NAME = os.path.join(BASE_DIR, "vidhi_users.db")
